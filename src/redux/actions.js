...
export const thoigiankhamActions = {
    SELECTED: 'SELECTED_ngaykham',
};

export const noidungkhamActions = {
    SELECTED: 'SELECTED_noidungkham',
};

export const loaikhamActions = {
    SELECTED: 'SELECTED_loaikham',
};

export const dangkykhamActions = {
...
export const signinActions = {
    PENDING: 'FETCH_signin_PENDING',
    SUCCESSFUL: 'SUCCESSFUL_signin',
};